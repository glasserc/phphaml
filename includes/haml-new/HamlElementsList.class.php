...
require_once dirname(__FILE__) . '/../common/CommonElementsList.class.php';
require_once dirname(__FILE__) . '/HamlElement.class.php';
 ...
 * @subpackage Haml
 */
class HamlElementsList extends CommonElementsList
{
}
